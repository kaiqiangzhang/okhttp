...
public final class HttpEngine {
  ...
  public HttpEngine(OkHttpClient client, HttpUrl userRequestUrl, boolean bufferRequestBody,
   ...
   * {@link #recover}.
   */
  public Response proceed(Request userRequest) throws RouteException, IOException {
    ...
    if (hasBody(userResponse)) {
      CacheRequest cacheRequest = maybeCache(userResponse, networkResponse.request(), responseCache);
  ...
  private HttpStream connect(Request networkRequest) throws RouteException, IOException {
  ...
  public HttpEngine recover(IOException e, boolean routeException, Response userResponse) {
    ...
    return new HttpEngine(client, userRequestUrl, bufferRequestBody, forWebSocket, streamAllocation,
        priorResponse);
  }
